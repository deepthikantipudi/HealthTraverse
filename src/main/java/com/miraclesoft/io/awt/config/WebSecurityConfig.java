...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		.authorizeRequests().antMatchers("/authenticate","/BP*","/plans","/plan/*","*","/addplans","/addclaim","/claims","/actuator/*","/api/*","/myheart","*","/BP/AverageBP/*/*","/GL/PatientGLs","/v2/api-docs", 
	             ...
	             "/api/medications/addPP","/api/medications/addPPD",
	             "/api/medications/addmedication","/app/userid/{id}",
	             "/api/medications/getmedpres","/temp/*",
	             "/uploadFile","/downloadFile/*","/uploadMultipleFiles",
	             "/Weight/CurrentWeight/{patientId}").permitAll().
