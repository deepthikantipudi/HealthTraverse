...
//	             "/api/medications/addPP","/api/medications/addPPD","/api/medications/addmedication","/app/userid/{id}","/api/medications/getmedpres","/medical-conditions/*","/add-medical-conditions","/medical-condition/*","/temp/*","/uploadFile","/downloadFile/*","/uploadMultipleFiles","/Weight/CurrentWeight/{patientId}").permitAll().
